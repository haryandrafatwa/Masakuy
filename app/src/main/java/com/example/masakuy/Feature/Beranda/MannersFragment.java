...
public class MannersFragment extends Fragment {
    ...
    private void initialize(){
        ...
        et_ingredients = getActivity().findViewById(R.id.tv_manners_recipe_detail);
        tv_edit_ingredients = getActivity().findViewById(R.id.tv_edit_manners);
        btnUpdate = getActivity().findViewById(R.id.btn_update_manners_resep);
        ...
        et_ingredients.setText(recipeModel.getCara_masak());
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(deskripsi)){
                    Toast.makeText(getActivity(), "Silahkan isi cara masak terlebih dahulu!", Toast.LENGTH_SHORT).show();
                }else{
                    recipeRefs.child("cara_masak").setValue(deskripsi).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
